...
:: Android packaging
set AND_CERT_NAME="isKing"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\isKing.p12
...
set IOS_DEV_CERT_FILE=cert\nba.p12
set IOS_DEV_CERT_PASS=000000
...
set APP_ID=com.rekoo.nbatest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=isKing
